          ...
          <FadeIn>
            <Card className="bg-card shadow-soft-md rounded-2xl border-0">
              <CardHeader className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-base mt-0.5">Paste your existing listing content below</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-5 px-6 pb-6">
                ...
                <div className="space-y-2.5">
                  <label className="text-base font-medium text-muted-foreground">Listing Title</label>
                  <div className="h-12 rounded-xl border border-border bg-muted/30 px-4 flex items-center text-base text-muted-foreground">
                    Paste your listing title...
                  </div>
                </div>
                <div className="space-y-2.5">
                  <label className="text-base font-medium text-muted-foreground">Bullet Points / Highlights</label>
                  <div className="min-h-[120px] rounded-xl border border-border bg-muted/30 p-4 text-base text-muted-foreground">
                    Paste bullet points...
                  </div>
                </div>
                <div className="space-y-2.5">
                ...
                <div className="h-12 w-full rounded-xl bg-primary/20 flex items-center justify-center text-base font-medium text-primary/50 cursor-not-allowed">
                  Score My Listing
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card shadow-soft-md rounded-2xl border-0">
              <CardContent className="pt-7 pb-5">
                <div className="flex flex-col items-center text-center">
                  <div className="h-28 w-28 rounded-full border-4 border-border flex items-center justify-center mb-4">
                    <span className="text-4xl font-bold text-muted-foreground">--</span>
                  </div>
                  <p className="text-base font-medium">Overall Score</p>
                  <p className="text-base text-muted-foreground mt-1.5">Submit a listing to see your score</p>
                </div>
              </CardContent>
            </Card>
          </FadeIn>
