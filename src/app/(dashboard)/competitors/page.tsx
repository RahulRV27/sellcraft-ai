      ...
      <StaggerContainer className="grid gap-5 grid-cols-2 lg:grid-cols-4 mb-8">
        {analysisAreas.map((area) => (
          <StaggerItem key={area.name}>
            <div className="flex items-center gap-4 rounded-xl border border-border bg-card/80 shadow-soft-sm p-5">
              <area.icon className="h-6 w-6 text-primary shrink-0" />
              <div>
        ...
        <Card className="bg-card shadow-soft-md rounded-2xl border-0">
          <CardHeader className="p-6">
            <div className="flex items-center gap-4">
              <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-rose-100 to-orange-100 flex items-center justify-center">
                <Users className="h-6 w-6 text-primary" />
              </div>
              <div>
                <CardTitle className="text-lg">Competitor Listing</CardTitle>
                <CardDescription className="text-base mt-0.5">Paste a competitor&apos;s listing to analyze their strategy</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-5 px-6 pb-6">
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div className="space-y-2.5">
                <label className="text-base font-medium text-muted-foreground">Listing URL (optional)</label>
                <div className="h-12 rounded-xl border border-border bg-muted/30 px-4 flex items-center gap-3 text-base text-muted-foreground">
            ...
            <div className="space-y-2.5">
              <label className="text-base font-medium text-muted-foreground">Competitor Listing Content</label>
              <div className="min-h-[170px] rounded-xl border border-border bg-muted/30 p-4 text-base text-muted-foreground">
            ...
            <div className="rounded-xl border border-dashed border-border bg-muted/20 p-10 text-center">
              ...
              <p className="text-base text-muted-foreground">Analysis results will appear here</p>
              <p className="text-base text-muted-foreground/70 mt-2">Including score breakdown, keyword gaps, and actionable recommendations</p>
            </div>
          </CardContent>
        </Card>
      </FadeIn>
