...
export default function OptimizePage() {
  return (
    <>
      ...
      <FadeIn>
        <div className="flex items-center gap-3 rounded-xl border border-primary/20 bg-primary/5 p-3 sm:p-5 mb-6 sm:mb-8">
          ...
          <Card className="bg-card shadow-soft-md rounded-2xl border-0">
            <CardHeader className="p-4 sm:p-6">
              <div className="flex items-center gap-4">
                <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-gradient-to-br from-red-100 to-orange-100 flex items-center justify-center">
                  <span className="text-base font-bold text-red-500">B</span>
                </div>
                <div>
                  <CardTitle className="text-base sm:text-lg">Before</CardTitle>
                  <CardDescription className="text-sm sm:text-base mt-0.5">Paste your current listing</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4 sm:space-y-5 px-4 sm:px-6 pb-4 sm:pb-6">
              ...
              <div className="space-y-2">
                <label className="text-sm sm:text-base font-medium text-muted-foreground">Your Current Listing</label>
                <div className="min-h-[160px] sm:min-h-[220px] rounded-xl border border-border bg-muted/30 p-3 sm:p-4 text-sm sm:text-base text-muted-foreground">
          ...
          <Card className="bg-card shadow-soft-md rounded-2xl border-0 relative">
            ...
            <CardHeader className="p-4 sm:p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <CardTitle className="text-base sm:text-lg">After</CardTitle>
                  <CardDescription className="text-sm sm:text-base mt-0.5">AI-optimized version</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="px-4 sm:px-6 pb-4 sm:pb-6">
              <div className="min-h-[200px] sm:min-h-[310px] rounded-xl border border-dashed border-border bg-muted/20 p-5 sm:p-8 flex flex-col items-center justify-center text-center">
                <Sparkles className="h-8 w-8 sm:h-10 sm:w-10 text-muted-foreground/40 mb-3 sm:mb-4" />
                <p className="text-sm sm:text-base text-muted-foreground">Your optimized listing will appear here</p>
                <p className="text-xs sm:text-base text-muted-foreground/70 mt-1.5 sm:mt-2">with highlighted improvements and score comparison</p>
              </div>
            </CardContent>
          </Card>
        </FadeIn>
