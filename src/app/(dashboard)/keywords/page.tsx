          ...
          <StaggerItem key={type.name}>
            <Card className="bg-card shadow-soft-md rounded-2xl border-0">
              <CardContent className="pt-6 pb-5">
                <type.icon className="h-5 w-5 text-primary mb-3" />
                <p className="text-3xl font-bold">{type.count}</p>
                <p className="text-base font-medium mt-1.5">{type.name}</p>
      ...
      <FadeIn>
        <Card className="bg-card shadow-soft-md rounded-2xl border-0">
          <CardHeader className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <CardDescription className="text-base mt-0.5">Enter a product name or category to discover relevant keywords</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-5 px-6 pb-6">
            ...
            <div className="space-y-2.5">
              <label className="text-base font-medium text-muted-foreground">Product / Search Term</label>
              <div className="flex gap-3">
                <div className="h-12 flex-1 rounded-xl border border-border bg-muted/30 px-4 flex items-center text-base text-muted-foreground">
                  e.g. stainless steel water bottle
                </div>
                <div className="h-12 px-6 rounded-xl bg-primary/20 flex items-center gap-2 text-base font-medium text-primary/50 cursor-not-allowed shrink-0">
            ...
            <div className="rounded-xl border border-dashed border-border bg-muted/20 p-10 text-center">
              ...
              <p className="text-base text-muted-foreground">Keywords will appear here</p>
              <p className="text-base text-muted-foreground/70 mt-2">Ranked by estimated search volume with Hinglish variations</p>
            </div>
          </CardContent>
        </Card>
      </FadeIn>
